      ...
      <div className="flex-1 overflow-y-auto space-y-3">
        {messages?.map((message) => {
          ...
          return (
            ...
            >
              <div className={`${isCurrentUserSender ? "text-transparent" : "text-[#820F17]"} pl-2`}>
                <div className="sender-uid text-[#D15734]">{message.sender?.uid}</div>
      ...
      <div className="flex-shrink-0 bg-white dark:bg-gray-800 border-t border-gray-200">
        <form onSubmit={handleSubmit} className="p-0">
          ...
          <div className="flex items-center py-2 bg-gray-50 dark:bg-gray-700">
            ...
            <button
              type="submit"
              className="p-2 text-[#820F17] rounded-full hover:bg-[#820F17] hover:text-[#F5E9DC] transition"
            >
